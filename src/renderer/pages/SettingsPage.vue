  ...
  <div class="min-h-screen container mx-auto px-2 text-gray-800 dark:text-blue-500">
    ...
    <div class="flex gap-4 mb-4">
      <transition name="page" mode="out-in">
        <button v-if="buttonStatus" @click="stopPython()" class="bg-blue-500 px-6 py-2 rounded-sm text-white font-semibold w-[320px]">Остановить Python скрипт</button>
        <button v-else @click="runPythonScript()" class="bg-blue-500 px-6 py-2 rounded-sm text-white font-semibold w-[320px]">Запустить Python скрипт</button>
      </transition>
    </div>
